# /create-excalidraw-flowchart Command

When this command is used, execute the following workflow:

## Create Excalidraw Flowchart Workflow
...
This command executes the Create Excalidraw Flowchart workflow from the BMAD BMM module.
