# /create-excalidraw-wireframe Command

When this command is used, execute the following workflow:

## Create Excalidraw Wireframe Workflow
...
This command executes the Create Excalidraw Wireframe workflow from the BMAD BMM module.
